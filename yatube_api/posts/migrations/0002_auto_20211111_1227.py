# Generated by Django 2.2.16 on 2021-11-11 07:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Введите имя сообщества', max_length=200, verbose_name='Имя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='Подпишитесь на автора', on_delete=django.db.models.deletion.CASCADE, related_name='follower', to=settings.AUTH_USER_MODEL, verbose_name='Фолловер')),
            ],
            options={
